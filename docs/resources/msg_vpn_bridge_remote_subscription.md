...
description: |-
  ...
  The import identifier for this resource is {msgVpnName}/{bridgeName}/{bridgeVirtualRouter}/{remoteSubscriptionTopic}, where {&lt;attribute&gt;} represents the value of the attribute and it must be URL-encoded.
---

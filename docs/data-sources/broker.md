...
- `config_sync_client_profile_tcp_initial_congestion_window` (Number, Deprecated) Obsolete.
...
- `config_sync_client_profile_tcp_max_window` (Number, Deprecated) Obsolete.

	...
	info := broker.EntityInputs{
		...
		Attributes: []*broker.AttributeInfo{
			...
			},
			{
				...
				MarkdownDescription: "The required audience value for a token to be considered valid. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`. Deprecated since SEMP API version 2.25. authenticationOauthProviders replaced by authenticationoauth_profiles.",
				Deprecated:          true,
				Type:                types.StringType,
				TerraformType:       tftypes.String,
				Converter:           broker.SimpleConverter[string]{TerraformType: tftypes.String},
			...
			},
			{
				...
				MarkdownDescription: "Enable or disable audience validation. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `false`. Deprecated since SEMP API version 2.25. authenticationOauthProviders replaced by authenticationoauth_profiles.",
				Deprecated:          true,
				Type:                types.BoolType,
			...
			},
			{
				...
				MarkdownDescription: "The number of seconds between forced JWKS public key refreshing. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `86400`. Deprecated since SEMP API version 2.25. authenticationOauthProviders replaced by authenticationoauth_profiles.",
				Deprecated:          true,
			...
			},
			{
				...
				MarkdownDescription: "The URI where the OAuth provider publishes its JWKS public keys. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`. Deprecated since SEMP API version 2.25. authenticationOauthProviders replaced by authenticationoauth_profiles.",
				Deprecated:          true,
				Type:                types.StringType,
				TerraformType:       tftypes.String,
				Converter:           broker.SimpleConverter[string]{TerraformType: tftypes.String},
			...
			},
			{
				...
				MarkdownDescription: "The name of the Message VPN. Deprecated since SEMP API version 2.25. Replaced by authenticationoauth_profiles.",
				Identifying:         true,
				Required:            true,
				ReadOnly:            true,
			...
			},
			{
				...
				MarkdownDescription: "The name of the OAuth Provider. Deprecated since SEMP API version 2.25. Replaced by authenticationoauth_profiles.",
				Identifying:         true,
				Required:            true,
				RequiresReplace:     true,
				Deprecated:          true,
			...
			},
			{
				...
				MarkdownDescription: "The token introspection URI of the OAuth authentication server. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`. Deprecated since SEMP API version 2.25. authenticationOauthProviders replaced by authenticationoauth_profiles.",
				Deprecated:          true,
				Type:                types.StringType,
				TerraformType:       tftypes.String,
				Converter:           broker.SimpleConverter[string]{TerraformType: tftypes.String},

	...
	info := broker.EntityInputs{
		...
		Attributes: []*broker.AttributeInfo{
			...
			},
			{
				...
				MarkdownDescription: "The name of the Bridge. Deprecated since SEMP API version 2.18. Common Name validation has been replaced by Server Certificate Name validation.",
				Identifying:         true,
				Required:            true,
				ReadOnly:            true,
			...
			},
			{
				...
				MarkdownDescription: "The name of the Message VPN. Deprecated since SEMP API version 2.18. Common Name validation has been replaced by Server Certificate Name validation.",
				Identifying:         true,
				Required:            true,
				ReadOnly:            true,
				RequiresReplace:     true,

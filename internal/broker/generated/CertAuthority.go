	...
	info := broker.EntityInputs{
		...
		Attributes: []*broker.AttributeInfo{
			...
			},
			{
				...
				MarkdownDescription: "The name of the Certificate Authority. Deprecated since SEMP API version 2.19. Replaced by clientCertAuthorities and domainCertAuthorities.",
				Identifying:         true,
				Required:            true,
			...
			},
			{
				...
				MarkdownDescription: "The PEM formatted content for the trusted root certificate of a Certificate Authority. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `\"\"`. Deprecated since SEMP API version 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.",
				Deprecated:          true,
				Type:                types.StringType,
				TerraformType:       tftypes.String,
				Converter:           broker.SimpleConverter[string]{TerraformType: tftypes.String},
			...
			},
			{
				...
				MarkdownDescription: "The scheduled CRL refresh time(s), specified as \"hourly\" or a comma-separated list of 24-hour times in the form hh:mm, or h:mm. There must be no spaces, and times must be in sorted order from 0:00 to 23:59. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `\"3:00\"`. Deprecated since SEMP API version 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.",
				Deprecated:          true,
			...
			},
			{
				...
				MarkdownDescription: "Enable or disable Certificate Authority revocation checking. Changes to this attribute are synchronized to HA mates via config-sync. The default value is `false`. Deprecated since SEMP API version 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.",
				Deprecated:          true,
				Type:                types.BoolType,
				TerraformType:       tftypes.Bool,
				Converter:           broker.SimpleConverter[bool]{TerraformType: tftypes.Bool},
